...
const testCase: Case = {
  ...
  mustInclude: [
    ...
    'create procedure SALES/PROC1 (in P1 int) language sql begin end;',
    'create function SALES/FN1 (P1 int) returns int language sql begin end;',
    'create trigger SALES/TR1 after insert on SALES/CUSTOMER begin end;',
